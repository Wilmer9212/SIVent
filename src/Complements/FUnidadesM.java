 ...
 * @author Elliot
 */
public class FUnidadesM extends javax.swing.JFrame {

    /**
     * Creates new form FUnidadesM
     */
     
    UnidadesmJpaController Controller = new UnidadesmJpaController();
  ...
  public void llenartb(String descripcion){
    ...
    private List<Unidadesm> buscarU(String descripcion) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FUnidadesM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FUnidadesM().setVisible(true);
            }
        });
    }
